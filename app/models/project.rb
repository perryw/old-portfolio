class Project < ActiveRecord::Base
  ...
  def ordered_resources
    resources_order = (resources_order.split(',').collect!{ |n| n.to_i } + resource_ids).uniq! rescue resource_ids
  ...
  def ordered_deliverables
    deliverables_order = (deliverables_order.split(',').collect{|n| n.to_i} + deliverable_ids).uniq! rescue deliverable_ids
