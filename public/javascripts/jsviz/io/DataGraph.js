...
DataGraph.prototype.getNode = function(index) {
	return this.nodes[index];
}
DataGraph.prototype.findNode = function( dataGraphNode ) {
	for( nIdx in this.nodes ) {
		if( this.nodes[nIdx].URL && this.nodes[nIdx].URL == dataGraphNode.URL ) { return nIdx; }
	}
	return false;
}
/*
