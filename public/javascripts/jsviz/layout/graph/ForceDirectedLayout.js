...
ForceDirectedLayout.prototype.handleMouseMoveEvent = function( nodeElement, e ) {
	if ( this.model.selected && !this.model.particles[this.model.selected].fixed ) {
		...
		mouseX -= 2.5*(this.view.centerX+this.container.offsetLeft);  // perryw 
		mouseY -= 1.5*this.view.centerY+1.5*this.container.offsetTop;
...
ForceDirectedLayout.prototype.handleMouseClickEvent = function( id ) {
		var node = this.model.particles[id];
}
/*
 * Handle a new node.
 *  
