...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <title>test/pdf_attachment_test.rb at c4e5b161a43021d107e80e158ed077a5fd65b8cf from jkebinger's attachment_fu - GitHub</title>
...
<div id="repos">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/jkebinger/attachment_fu/tree">attachment_fu</a></b> / <a href="/jkebinger/attachment_fu/tree/c4e5b161a43021d107e80e158ed077a5fd65b8cf/test">test</a> / pdf_attachment_test.rb
    </div>
    ...
    <div id="files">
      <div class="file">
        <div class="meta">
          <div class="info">
            <span>100644</span>
            <span>22 lines (12 sloc)</span>
            <span>0.592 kb</span>
          </div>
          <div class="actions">
            
            <a href="/jkebinger/attachment_fu/raw/c4e5b161a43021d107e80e158ed077a5fd65b8cf/test/pdf_attachment_test.rb" id="raw-url">raw</a>
            
              <a href="/jkebinger/attachment_fu/blame/c4e5b161a43021d107e80e158ed077a5fd65b8cf/test/pdf_attachment_test.rb">blame</a>
            
            <a href="/jkebinger/attachment_fu/commits/master/test/pdf_attachment_test.rb">history</a>
          </div>
        </div>
...
<span id="LID22" rel="#L22">22</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class="line" id="LC1"><span class="nb">require</span> <span class="no">File</span><span class="o">.</span><span class="n">expand_path</span><span class="p">(</span><span class="no">File</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="no">File</span><span class="o">.</span><span class="n">dirname</span><span class="p">(</span><span class="bp">__FILE__</span><span class="p">),</span> <span class="s1">&#39;test_helper&#39;</span><span class="p">))</span></div><div class="line" id="LC2">&nbsp;</div><div class="line" id="LC3"><span class="k">class</span> <span class="nc">PdfAttachmentTest</span> <span class="o">&lt;</span> <span class="no">Test</span><span class="o">::</span><span class="no">Unit</span><span class="o">::</span><span class="no">TestCase</span></div><div class="line" id="LC4">&nbsp;&nbsp;<span class="n">attachment_model</span> <span class="no">PdfWithThumbsAttachment</span></div><div class="line" id="LC5">&nbsp;&nbsp;</div><div class="line" id="LC6">&nbsp;&nbsp;</div><div class="line" id="LC7">&nbsp;</div><div class="line" id="LC8">&nbsp;&nbsp;<span class="k">def</span> <span class="nf">test_should_create_thumbnail_with_png_type</span></div><div class="line" id="LC9">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">attachment</span> <span class="o">=</span> <span class="n">upload_file</span> <span class="ss">:filename</span> <span class="o">=&gt;</span> <span class="s1">&#39;/files/rails.pdf&#39;</span><span class="p">,</span> <span class="ss">:content_type</span> <span class="o">=&gt;</span> <span class="s1">&#39;pdf&#39;</span></div><div class="line" id="LC10">&nbsp;</div><div class="line" id="LC11">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">attachment</span><span class="o">.</span><span class="n">create_or_update_thumbnail</span><span class="p">(</span><span class="n">attachment</span><span class="o">.</span><span class="n">create_temp_file</span><span class="p">,</span> <span class="s1">&#39;thumb&#39;</span><span class="p">,</span> <span class="mi">50</span><span class="p">,</span> <span class="mi">50</span><span class="p">)</span></div><div class="line" id="LC12">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">attachment</span><span class="o">.</span><span class="n">save!</span></div><div class="line" id="LC13">&nbsp;</div><div class="line" id="LC14">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">thumbnail</span> <span class="o">=</span> <span class="n">attachment</span><span class="o">.</span><span class="n">thumbnails</span><span class="o">.</span><span class="n">first</span></div><div class="line" id="LC15">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">assert_equal</span> <span class="s1">&#39;pdf&#39;</span><span class="p">,</span> <span class="n">attachment</span><span class="o">.</span><span class="n">content_type</span>    </div><div class="line" id="LC16">&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">assert_equal</span> <span class="s1">&#39;image/png&#39;</span><span class="p">,</span> <span class="n">thumbnail</span><span class="o">.</span><span class="n">content_type</span></div><div class="line" id="LC17">&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="line" id="LC18">&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="line" id="LC19">&nbsp;&nbsp;<span class="k">end</span></div><div class="line" id="LC20">&nbsp;&nbsp;</div><div class="line" id="LC21">&nbsp;&nbsp;</div><div class="line" id="LC22"><span class="k">end</span></div></pre></div>
    ...
    <div id="footer">
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            <span id="_rrt" title="0.35313s from xc88-s00039">GitHub</span>
